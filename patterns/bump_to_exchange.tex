...
\newcommand{\desc}{Ein Daten-Austausch soll zwischen zwei (oder mehr) Geräten stattfinden.}

\newcommand{\solution}{Ein Quell-Gerät wird mit Ziel-Gerät leicht zusammengestoßen/gebumpt. Dadurch wird ein Datensatz zwischen den Geräten ausgetauscht.}
...
\newcommand{\reaction}{Die hauptsächliche Reaktion des Systems ist es, die angeforderten Daten vom Quellgerät auf dem Zielgerät (und umgekehrt) zu übertragen und dort anzuzeigen. Die Geräte sollten aber auch eine visuelle oder akustische Rückmeldung an die Benutzer geben, um zu signalisieren, dass ein Bump von den Endgeräten festgestellt wurde, z.B. über Vibration und mit welchem Gerät/Person Daten ausgetauscht werden.}
...
\newcommand{\prototype}{Die Bump-Interaktion besteht aus drei Teilsystemen:
