...
\newcommand{\desc}{Zwei Benutzer haben \data e\ auf ihren Geräten und wollen es durch direkten Kontakt miteinander teilen, sodass anschließend beide \data e\ auf beiden Geräten verfügbar sind.}

\newcommand{\solution}{Beide Benutzer haben ihr Gerät in der Hand. Durch das leichte Zusammenstoßen (\glslink{bump}{Bumpen}) der Geräte werden die \data e\ auf das jeweils andere Gerät übertragen.}
