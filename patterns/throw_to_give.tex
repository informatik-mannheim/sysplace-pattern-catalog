...
\item Das Sender-Gerät sollte handlich sein, um die definierte Mindestgeschwindigkeit der Geste zu erreichen ohne dabei das Gerät zu beschädigen.
\end{itemize}}
...
\newcommand{\validcontext}{Geeignet für z.B. Datenaustausch: Bilder, Videos, Dateien, Social Network IDs, Kontaktinformationen}
...
\newcommand{\otherpatterns}{Das Pattern Tennis - ähnlich in der Ausführung}
...
\newcommand{\metaphor}{}
\newcommand{\metaphordesc}{Frisbee, etwas wegwerfen}
