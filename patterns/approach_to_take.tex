...
\newcommand{\desc}{Ein Benutzer (der \rec{}) hat ein mobiles Gerät und möchte ein auf dem (öffentlichen) \sendev{} ausgewähltes \data{} empfangen. Es soll über Distanz vom \sendev{} auf das \recdev{} übertragen werden, sodass es anschließend auf beiden Geräten verfügbar ist.}

\newcommand{\solution}{Der Benutzer nähert (\gls{approach}) sich mit seinem Gerät (dem \recdev{}) einem entfernten Gerät (dem \sendev{}). Nähert er sich dem \sendev{} bis auf einen bestimmten räumlichen Abstand, wird das \data{} auf das \recdev{} übertragen.}
...
\newcommand{\reaction}{Beim Erreichen einer definierten Distanz zwischen Quell- und Ziel-Gerät wird visuell, akustisch oder auf eine andere Weise erkenntlich gemacht, dass sich das Quell- und Ziel-Gerät erkannt haben. Daraufhin fordert das Empfänger-Gerät vom Sender-Gerät ein Datenobjekt an und stellt es dar. TODO}
