...
\newcommand{\solution}{Das Empfänger-Gerät wird mit Sender-Gerät leicht zusammengestoßen/gebumpt. Dadurch fordert das Empfänger-Gerät vom Sender-Gerät einen Datensatz an.}
...
\newcommand{\reaction}{Die hauptsächliche Reaktion des Systems ist es, die angeforderten Daten vom Quellgerät auf dem Zielgerät zu übertragen und dort anzuzeigen. Die Geräte sollten aber auch eine visuelle oder akustische Rückmeldung an die Benutzer geben, um zu signalisieren, dass ein Bump von den Endgeräten festgestellt wurde, z.B. über Vibration und mit welchem Gerät/Person Daten ausgetauscht werden.}
