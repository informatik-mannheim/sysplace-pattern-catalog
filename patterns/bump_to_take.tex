...
\newcommand{\reactionSen}{Handelt es sich bei dem \sendev\ um ein mobiles Gerät, das von einem Nutzer gehalten wird, werden die selben atomaren Interaktionen ausgeführt wie auf dem \recdev .\ Bei erfolgreicher Anforderung des \data s\ (Atomare Reaktion \textit{Receive Request}) sollte auf dem \sendev\ Feedback über die Anforderung und das anschließende Versenden des \data s\ gegeben werden.}
