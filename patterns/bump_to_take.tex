...
\item \textbf{Connectivity}: Ziel der Bump To Take Geste ist die Dateiübertragung zwischen zwei Geräten, die bereits über ein Ad-Hoc Netzwerk wie Bluetooth oder WiFi Direct miteinander verbunden sind. Alternativ kann auch eine Vermittlungskomponente (Server) genutzt werden, der den Datenaustausch zentral verwaltet und die Bumperkennung durchführt.
\end{itemize}
...
Da bei Bump To Take bereits eine Verbindung zwischen den Geräten besteht, ist es auch möglich, dass eins der Geräte das \textit{Bump Event Matching} durchführt und dadurch als Vermittlungskomponente fungiert.
