...
Bei einem \textit{erfolgreich} ausgeführten Swipe finden alle Microinteractions statt und können jeweils mit Feedback versehen werden, nach Beendigung der letzten Phase wird der Transfer des selektierten \data s\ ausgeführt. Bei \textit{nicht erfolgreichem} Swipe wird kein Transfer ausgeführt, einzelne Microinteractions des Swipes können entfallen.}
...
Touch ausgeführt, \newline Move nicht ausgeführt & Animation 2 \\ 
\hline
Release & M & Touch Up Event auf dem Screen & Swipelänge OK, \newline Swipedauer OK, \newline Swipeorientierung OK & Animation 3 \\ 
\hline
Receive & S & Daten empfangen & \data\ ist darstellbar & Animation, Vibration \\
\hline
\end{tabularx}
\end{table}
*Typ: (M)anual, (S)ystem, (A)utomatic
\end{figure}
}
