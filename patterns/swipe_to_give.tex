...
\newcommand{\reactionSen}{Auf dem \sendev\ kann dem Nutzer zu verschiedenen Phasen des Swipes ein Feedback gegeben werden. Ein Swipe besteht aus den drei \Glspl{microinteraction} \textit{Touch}, \textit{Move} und \textit{Release}.\\
...
\caption{Benötigte Technologie für das Swipe To Give Pattern}
...
\item Überprüfen eventueller \textit{Constraints} an die Geste
\end{itemize}
