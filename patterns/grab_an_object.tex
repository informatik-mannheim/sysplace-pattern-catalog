...
\newcommand{\solution}{Durch Auflegen eines Ziel-Gerätes auf ein Quell-Gerät wird ein ausgewähltes Datenobjekt vom Sender- auf das Empfänger-Gerät übertragen. Nach dem Wiederwegnehmen ist das Datenobjekt auch auf dem Ziel-Gerät verfügbar.}
...
\newcommand{\useraction}{Der Anwender legt ein Ziel-Gerät auf ein Quell-Gerät. 
Anschließend nimmt der Anwender das Ziel-Gerät wieder weg.}

\newcommand{\reaction}{Das ausgewählte Datenobjekt auf dem Quell-Gerät wird auf dem Bildschirm des Ziel-Gerätes dargestellt.}
...
\newcommand{\otherpatterns}{Grab A Part - analoge Interaktion, aber hierbei wird ein Ausschnitt aus einer unendlichen Menge (z.B. Landkarte) ausgewählt durch das Auflegen des Ziel-Gerätes.}
...
\newcommand{\metaphor}{}
\newcommand{\metaphordesc}{Ein Medium hinlegen, wie ein Schwamm, das den Inhalt von dem anderen Medium aufsaugt. Nach etwas greifen/aufheben, wie nach einem Prospekt.}
...
\newcommand{\dateofcreation}{08.05.2016}
