...
Durch die Nähe wird veranlasst, dass ein Datenobjekt vom Quell-Gerät auf das Ziel-Gerät gesendet wird.}
...
\newcommand{\reaction}{Beim Erreichen einer definierten Distanz zwischen Quell- und Ziel-Gerät wird visuell, akustisch oder auf eine andere Weise erkenntlich gemacht, dass sich das Quell- und Ziel-Gerät erkannt haben. Daraufhin wird ein ausgewähltes Datenobjekt vom Sender-Gerät auf das Empfänger gerät übertragen und auf dem Ziel-Gerät dargestellt.}
...
\newcommand{\reactionFailureConnectionDesc}{haben das Quell- und Ziel-Gerät den Mindest-Abstand zueinander nicht erreicht. Die Distanz darf ggf. nicht zu klein definiert sein. Solange keine funktionierende Verbindung zwischen den Geräten hergestellt werden kann, sucht das Quell-Gerät weiterhin nach dem Ziel-Gerät. Dadurch kann die Datenübertragung nicht stattfinden.}
...
\newcommand{\reactionFailureCompatibilityDesc}{muss das Quell-Gerät bei gescheitertem Verbindungsaufbau zum Ziel-Gerät einen Hinweis anzeigen, dass das Ziel-Gerät nicht kompatibel ist, um Daten vom Sender-Gerät zu empfangen bzw. darzustellen.}
