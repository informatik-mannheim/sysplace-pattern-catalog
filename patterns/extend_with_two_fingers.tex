...
\newcommand{\useraction}{Der Anwender legt ein Quell-Gerät an ein Ziel-Gerät an. Dann platziert der Anwender einen Finger (z.B. Zeigefinger) auf dem Display des Quell-Gerätes. Anschließend platziert der Anwender einen anderen Finger (z.B. Daumen) auf dem Display des Ziel-Gerätes. Die beiden Finger zieht er zusammen bis sie sich berühren.}

\newcommand{\reaction}{Durch Auflegen des ersten Fingers wird das Quell-Gerät bestimmt. Durch Auflegen des zweiten Fingers das Ziel-Gerät. Sobald beide Finger außerhalb des Displayrandes beider Geräte gezogen wurden, wird der Bildschirm-Inhalt des Quell-Gerätes auf dem Ziel-Gerät erweitert dargestellt.}
...
\item Appose - Der Bildschirm-Inhalt des Quell-Gerätes wird durch Anlegen eines Ziel-Gerätes auf diesem erweitert dargestellt. 
\end{itemize}}
