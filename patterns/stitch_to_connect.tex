...
\item Release-Animation: visualisiert dem Benutzer, dass die Geste erfolgreich ausgeführt wurde und ein Verbindungsaufbau initiiert wird (z.B.\sendev{}: Der Stecker fährt zur Hälfte aus dem Bildschirm heraus.  \recdev{}: Ein Stecker fährt zur Hälfte auf den Bildschirm.
)
\item Stitch-Recognized-Animation: visualisiert dem Benutzer, dass der ausgeführte Stitch erfolgreich erkannt wurde (z.B. Der Stecker wird in die Steckdose gesteckt.)
...
\item[-] Da es sich bei Stitch to Connect um eine synchrone Geste handelt, müssen die Geräte miteinander kommunizieren können, sodass die beiden Teile der Geste miteinander verglichen werden können.
...
\item[-] Für manche Anwendungsfälle könnte die Stitch-Richtung interessant sein, auch wenn sie technisch nicht notwendig ist.
\end{itemize}}
...
\newcommand{\notvalidcontext}{
\begin{itemize}
\item Verbinden mit entfernten Geräten.
\item Verbinden mit mehreren Geräten gleichzeitig.
\end{itemize}}
...
\newcommand{\metaphor}{}
\newcommand{\metaphordesc}{Einen Stecker in eine Steckdose stecken.}
...
\newcommand{\versionhistory}{16.02.2017}
