...
Durch die Nähe wird veranlasst, dass zwischen zwei (oder mehr) Geräten eine Verbindung hergestellt wird.}
...
\newcommand{\reaction}{Beim Erreichen einer definierten Distanz zwischen Quell- und Ziel-Gerät wird visuell, akustisch oder auf eine andere Weise erkenntlich gemacht, dass sich das Quell- und Ziel-Gerät erkannt haben und eine Verbindung zwischen den Geräten aufgebaut wurde.}
