...
\newcommand{\solution}{Ein Benutzer bewegt sich (Leave) sich mit seinem Gerät (dem Sendegerät) von einem entfernen Gerät (dem Empfängergerät) weg. Verlässt das Sendegerät einen definierten räumlichen Abstand zum Empfängergerät, wird die Verbindung zwichen dem Sende- und Empfängergerät abgebrochen.}
