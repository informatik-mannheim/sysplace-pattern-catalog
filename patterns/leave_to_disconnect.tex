...
\newcommand{\designnotes}{Das Empfängergerät sollte standfest sein, z.B. Tabletop oder Screen an der Wand. Das Sendegerät hingegen sollte handlich sein, z.B. Smartphone, Tablet, Smartwatch, um damit den definierten Radius um das Empfängergerät herum mühelos verlassen zu können.}

% -------------------------------
% WANN
% -------------------------------

\newcommand{\validcontext}{Um die Verbindung zwischen Geräten zu trennen.}
...
\newcommand{\figures}{...}
\newcommand{\versionhistory}{27.04.2017}
\newcommand{\dateofcreation}{05.09.2016}
\newcommand{\comments}{}
\newcommand{\questions}{...}
