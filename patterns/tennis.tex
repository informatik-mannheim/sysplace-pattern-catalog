...
\newcommand{\solution}{Der Anwender hält ein Quell-Gerät fest in der Hand und schwenkt es aus dem Unterarm heraus in Richtung des Ziel-Gerätes.}
...
\newcommand{\useraction}{Der Benutzer hat das Sender-Gerät fest in der Hand. Aus dem Unterarm heraus schwingt der Benutzer seinen Arm in Richtung des Empfänger-Gerätes und überträgt dabei ein Datenobjekt.}

\newcommand{\reaction}{Das Sender-Gerät erkennt eine Schwingbewegung. Dadurch wird ein ausgewähltes Datenobjekt an das Empfänger-Gerät übertragen und durch eine akustische Rückmeldung oder z.B. Vibration bestätigt.\\
...
\newcommand{\notvalidcontext}{Übermittlung von Datenobjekten, z.B. in Form von Bildern, Dateien}
