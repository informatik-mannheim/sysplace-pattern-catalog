...
\newcommand{\solution}{Durch Auflegen eines Ziel-Gerätes auf ein Quell-Gerät wird ein ausgewählter Bildausschnitt vom Quell- auf das Ziel-Gerät übertragen. Nach dem Wiederwegnehmen ist der Ausschnitt auch auf dem Ziel-Gerät verfügbar.}
...
\newcommand{\notvalidcontext}{Wenn die Fläche des ausgewählten Ausschnitts auf dem Sender-Gerät größer ist als das Display des Empfänger-Geräts.}
...
\newcommand{\otherpatterns}{Grab An Object - analoge Interaktion, aber hier wird ein zuvor definiertes Objekt (aus einer endlichen Menge) durch das Auflegen des Ziel-Gerätes ausgewählt.}
