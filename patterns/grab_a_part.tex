...
\newcommand{\solution}{Durch Auflegen eines Ziel-Gerätes auf ein Quell-Gerät wird ein ausgewählter Bildausschnitt vom Quell- auf das Ziel-Gerät übertragen. Nach dem Wiederwegnehmen ist der Ausschnitt auch auf Ziel-Gerät verfügbar.}
...
\newcommand{\otherpatterns}{Grab An Object - analoge Interaktion, aber hierbei wird ein zuvor definiertes Objekt (aus einer endlichen Menge) ausgewählt durch das Auflegen des Ziel-Gerätes.}
...
\newcommand{\metaphor}{}
\newcommand{\metaphordesc}{Ein Medium hinlegen, wie ein Schwamm, das den Inhalt von dem anderen Medium aufsaugt. Ausstanzen. Ausschneiden. Screenshot. Nach etwas greifen/aufheben, wie nach einem Prospekt.}
