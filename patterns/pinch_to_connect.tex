...
\newcommand{\solution}{Der \sen\ hat das \sendev\ Kante an Kante neben dem \recdev\ und führt eine \glslink{pinch}{Pinch-Geste} aus wodurch wird der Verbindungsvorgang angestoßen wird.}
...
\newcommand{\reactionSen}{Auf beiden Geräten sollte zu verschiedenen Phasen des Pinchs Feedback gegeben werden. Ein Bump besteht aus den drei \glslink{atomareinteraktion}{atomaren Interaktionen} \textit{Move}, \textit{Abrupt Stop} und \textit{Bump Recognized}.\\
